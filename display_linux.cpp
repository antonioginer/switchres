...
//============================================================
//  linux_display::init_osd
//============================================================

bool linux_display::init_osd()
{
	...
	log_verbose("SwitchRes: DEVELOPMENT VERSION - NOT RECOMMENDED FOR PRODUCTION ENVIRONMENT\n");
...
//============================================================
//  linux_display::modeline_setup
//============================================================

bool linux_display::modeline_setup()
{
	...
	//TODO		add_custom_video_mode(best_mode);
		}

		// Switch to the new mode
		//TODO set_custom_video_mode(best_mode);
	}
...
//============================================================
//  linux_display::modeline_remove
//============================================================

bool linux_display::modeline_remove()
{
	return true;
}

//============================================================
//  linux_display::modeline_reset
//============================================================

bool linux_display::modeline_reset()
{
	//modeline *mode_table = machine.switchres.video_modes;
	...
	while (mode_count > 1)
	{
		//TODO del_custom_video_mode(&mode_table[mode_count]);
		mode_count--;
	}
...
//============================================================
//  linux_display::resolution_change
//============================================================

bool linux_display::resolution_change()
{
...
//============================================================
//  linux_display::add_custom_video_mode
//============================================================

bool linux_display::add_custom_video_mode(modeline *mode)
{
	if (!mode)
		return false;
...
//============================================================
//  linux_display::set_custom_video_mode
//============================================================

bool linux_display::set_custom_video_mode(modeline *mode)
{
...
//============================================================
//  linux_display::del_custom_video_mode
//============================================================

int linux_display::del_custom_video_mode(modeline *mode)
{
	if (!mode)
		return false;
